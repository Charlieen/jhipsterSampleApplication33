...
import { JhipsterSampleApplication33SharedModule, UserRouteAccessService } from './shared';
import { JhipsterSampleApplication33HomeModule } from './home/home.module';
import { JhipsterSampleApplication33AdminModule } from './admin/admin.module';
import { JhipsterSampleApplication33AccountModule } from './account/account.module';
...
@NgModule({
    imports: [
        ...
        JhipsterSampleApplication33AdminModule,
        JhipsterSampleApplication33AccountModule,
